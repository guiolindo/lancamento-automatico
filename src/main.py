...
BUILD_MARKER = "build-113 (novo imposto FGTS_CONSIG no Operador Financeiro — 2 valores por linha, espécie por coluna MFGTS/CONSIG, pessoa vem do codigo_consinco da filial)"
