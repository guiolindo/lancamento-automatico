...
CAMPOS = [
    ...
    ("contab_linha1_filial",       "Célula Filial — linha 1 da contab.",    False),
    ("contab_linha1_valor",        "Célula Valor — linha 1 da contab.",     False),
    ("contab_linha2_filial",       "Célula Filial — linha 2 da contab.",    False),
    ("contab_linha2_conta_debito", "Célula Conta Débito — linha 2",         False),
    ("contab_linha2_cr",           "Célula CR — linha 2 da contab.",        False),
